  ...
  input_schema: {
    ...
    properties: {
      intent: {
        ...
        description:
          'SIZE_EXCHANGE: wants a different size or color of an item they bought. This INCLUDES a fit complaint about an item they already own ("this is too small / too tight / does not fit", "the medium runs small") even when they have not yet named the replacement size - do NOT put fit complaints in OTHER. It does NOT include a shirt that arrived in a DIFFERENT size, color or design than the one they ORDERED ("I ordered a 3X but received a 4X", "I ordered Mustard and got Terracotta") - that is our print partner shipping the wrong item, so it is ORDER_ISSUE, including their follow-up that sends the photo of the label. ' +

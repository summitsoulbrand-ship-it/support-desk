...
- The BILLING address never needs to be updated or confirmed - if the payment went through, the order is fine. Only the SHIPPING address matters for delivery. For an address change, just update the shipping address; never ask the customer to fix, confirm, or worry about their billing address

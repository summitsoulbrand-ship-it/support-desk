...
type IntegrationType = 'ZOHO_IMAP_SMTP' | 'ZOHO_API' | 'SHOPIFY' | 'PRINTIFY' | 'CLAUDE' | 'SMARTYSTREETS' | 'META' | 'JUDGEME' | 'TRACKINGMORE';
    ...
    if (integration) {
      ...
      switch (type) {
        ...
        case 'PRINTIFY':
          ...
          break;
        case 'CLAUDE':
          setFormData({ apiKey: '', model: 'claude-opus-4-8', projectId: '', customPrompt: '' });
          break;
        case 'SMARTYSTREETS':
  ...
  const renderClaudeForm = () => (
    <div className="space-y-4">
      ...
      <div>
        ...
        <select
          value={(formData.model as string) || 'claude-opus-4-8'}
